...
//com.junkbyte.console.view.RollerPanel
...
package com.junkbyte.console.view
{
    ...
    public class RollerPanel extends ConsolePanel 
    {
        ...
        public function RollerPanel(_arg_1:Console)
        {
            super(_arg_1);
            name = NAME;
            init(60, 100, false);
        ...
        private function removeListeners(_arg_1:Event=null):void
        {
        ...
        private function _onFrame(_arg_1:Event):void
        {
            if (!console.stage)
            {
                this.close();
        ...
        public function getMapString(_arg_1:Boolean):String
        {
            ...
            for each (_local_7 in _local_5)
            {
                ...
                while (_local_12 < _local_11)
                {
                    ...
                    if (_local_6[_local_13] == undefined)
                    {
                        ...
                        if (((_arg_1) && (console.config.useObjectLinking)))
                        {
        ...
        {
            var _local_3:KeyBind;
            var _local_2:String = ((_arg_1.text) ? _arg_1.text.replace("event:", "") : "");
            if (_local_2 == "close")
            {
                _local_2 = "Close";
            }
        ...
        private function keyDownHandler(_arg_1:KeyboardEvent):void
        {
            ...
            var _local_2:String = String.fromCharCode(_arg_1.charCode);
            this.cancelCaptureKeySet();
            console.setRollerCaptureKey(_local_2, _arg_1.shiftKey, _arg_1.ctrlKey, _arg_1.altKey);
            console.panels.tooltip(null);
        }
