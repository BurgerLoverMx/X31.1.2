...
package robotlegs.bender.extensions.mediatorMap
{
    ...
    public class MediatorMapExtension implements IExtension 
    {
        ...
        public function extend(_arg_1:IContext):void
        {
            ...
            _arg_1.lifecycle.beforeInitializing(this.beforeInitializing);
            _arg_1.lifecycle.beforeDestroying(this.beforeDestroying);
        ...
        {
            var _local_1:IMediatorFactory = this._injector.getInstance(IMediatorFactory);
            _local_1.removeAllMediators();
            if (this._injector.satisfiesDirectly(IViewManager))
            {
                this._viewManager = this._injector.getInstance(IViewManager);
