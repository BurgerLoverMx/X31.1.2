...
package com.hurlant.crypto.hash
{
    ...
    public class MD2 implements IHash 
    {
        ...
        public function hash(_arg_1:ByteArray):ByteArray
        {
            ...
            var _local_3:uint = ((16 - (_arg_1.length % 16)) || (16));
            do 
            {
            ...
            while (_local_3 < _local_4)
            {
                ...
                while (_local_8 < 16)
                {
                    _local_6 = (_local_5[_local_8] = (_local_5[_local_8] ^ S[(_arg_1[(_local_3 + _local_8)] ^ _local_6)]));
                    _local_8++;
                };
            ...
            while (_local_3 < _local_4)
            {
                ...
                while (_local_8 < 16)
                {
                    _local_7[(32 + _local_8)] = ((_local_7[(16 + _local_8)] = _arg_1[(_local_3 + _local_8)]) ^ _local_7[_local_8]);
                    _local_8++;
                };
                _local_9 = 0;
                _local_8 = 0;
                while (_local_8 < 18)
                {
                    ...
                    _local_9 = ((_local_9 + _local_8) & 0xFF);
                    _local_8++;
                };
                _local_3 = (_local_3 + 16);
            };
