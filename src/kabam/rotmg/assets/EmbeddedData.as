package kabam.rotmg.assets
{
   public class EmbeddedData
   {
      ...
      public static const groundFiles:Array = [new GroundCXML(),new parasiteDenGroundCXML(),new iceCaveGroundCXML(),new stPatricksGroundCXML(),new hanaminexusGroundCXML(),new mountainTempleGroundCXML(),new oryxHordeGroundCXML(),new battleOryxGroundCXML(),new summerNexusGroundCXML(),new autumnNexusGroundCXML(),new epicHiveGroundCXML(),new lostHallsGroundCXML(),new santaWorkshopGroundCXML(),new magicWoodsGroundCXML(),new cnidarianReefGroundCXML(),new secludedThicketGroundCXML()];
      ...
      public static function appendXML(param1:Array, param2:String, param3:String) : XML
      {
         var _loc6_:XML = null;
         var _loc7_:XML = null;
         var _loc4_:XML = new XML("<" + param2 + "></" + param2 + ">");
         var _loc5_:int = 0;
         while(_loc5_ < param1.length)
         {
            _loc6_ = XML(param1[_loc5_]);
            for each(_loc7_ in _loc6_[param3])
            {
               _loc4_ = _loc4_.appendChild(_loc7_);
            }
            _loc5_++;
         }
         return _loc4_;
