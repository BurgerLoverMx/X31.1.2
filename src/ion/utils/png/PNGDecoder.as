...
package ion.utils.png
{
    ...
    public class PNGDecoder 
    {
        ...
        public static function decodeImage(_arg_1:ByteArray):BitmapData
        {
        ...
        public static function decodeInfo(_arg_1:ByteArray):XML
        {
            var _local_4:int;
            if (_arg_1 == null)
            {
        ...
        private static function gettEXt(_arg_1:int, _arg_2:int):XML
        {
            ...
            var _local_5:* = "";
            var _local_6:int = -1;
            fileIn.position = _arg_1;
            while (fileIn.position < (_arg_1 + _arg_2))
            {
            ...
            _local_5 = fileIn.readUTFBytes(((_arg_1 + _arg_2) - fileIn.position));
            _local_3.appendChild(new (XML)((("<keyword>" + _local_4) + "</keyword>")));
            _local_3.appendChild(new (XML)((("<text>" + _local_5) + "</text>")));
            return (_local_3);
        }

        private static function getzTXt(_arg_1:int, _arg_2:int):XML
        {
            ...
            if (_local_7 == 0)
            {
                ...
                _local_8.writeBytes(fileIn, fileIn.position, ((_arg_1 + _arg_2) - fileIn.position));
                _local_8.uncompress();
        ...
        private static function getiTXt(_arg_1:int, _arg_2:int):XML
        {
            ...
            if (_local_9)
            {
                if (_local_10 == 0)
                {
                    ...
                    _local_11.writeBytes(fileIn, fileIn.position, ((_arg_1 + _arg_2) - fileIn.position));
            ...
            {
                _local_7 = fileIn.readUTFBytes(((_arg_1 + _arg_2) - fileIn.position));
            };
            _local_3.appendChild(new (XML)((("<keyword>" + _local_4) + "</keyword>")));
            _local_3.appendChild(new (XML)((("<text>" + _local_7) + "</text>")));
            _local_3.appendChild(new (XML)((("<languageTag>" + _local_5) + "</languageTag>")));
            _local_3.appendChild(new (XML)((("<translatedKeyword>" + _local_6) + "</translatedKeyword>")));
            return (_local_3);
        }
        ...
        private static function processIHDR(_arg_1:int):Boolean
        {
            if (_arg_1 != 13)
            {
                return (false);
        ...
        {
            var _local_1:uint = uint((buffer[buffer.position] + Math.floor(((byteA() + byteB()) / 2))));
            _local_1 = (_local_1 & 0xFF);
            var _local_2:* = buffer.position++;
            buffer[_local_2] = _local_1;
            return (_local_1);
