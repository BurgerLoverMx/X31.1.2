...
//robotlegs.bender.extensions.commandCenter.impl.CommandMapping
...
package robotlegs.bender.extensions.commandCenter.impl
{
    ...
    public class CommandMapping implements ICommandMapping, ICommandMappingConfig 
    {
        ...
        public function CommandMapping(_arg_1:Class)
        {
            this._commandClass = _arg_1;
        }
        ...
        public function once(_arg_1:Boolean=true):ICommandMappingConfig
        {
        ...
        public function set next(_arg_1:ICommandMapping):void
        {
            this._next = _arg_1;
        }

        private function throwMappingError(_arg_1:String):void
        {
            throw (new CommandMappingError(_arg_1));
        }
