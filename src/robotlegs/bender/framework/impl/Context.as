...
//robotlegs.bender.framework.impl.Context
...
package robotlegs.bender.framework.impl
{
    ...
    public class Context implements IContext 
    {
        ...
        {
            this._logManager.logLevel = _arg_1;
        }
        ...
        public function extend(... _args):IContext
        {
            ...
            {
                this._extensionInstaller.install(_local_2);
            };
            return (this);
        }
        ...
        public function configure(... _args):IContext
        {
            ...
            for each (_local_2 in _args)
            {
                this._configManager.addConfig(_local_2);
            };
            return (this);
        }

        public function addConfigHandler(_arg_1:Matcher, _arg_2:Function):IContext
        {
            this._configManager.addConfigHandler(_arg_1, _arg_2);
            return (this);
        }

        public function getLogger(_arg_1:Object):ILogger
        {
            return (this._logManager.getLogger(_arg_1));
        }

        public function addLogTarget(_arg_1:ILogTarget):IContext
        {
            this._logManager.addLogTarget(_arg_1);
            return (this);
        }
