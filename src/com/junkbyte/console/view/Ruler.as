...
//com.junkbyte.console.view.Ruler
...
package com.junkbyte.console.view
{
    ...
    public class Ruler extends Sprite 
    {
        ...
        public function Ruler(_arg_1:Console)
        {
            this._master = _arg_1;
            this._config = _arg_1.config;
            buttonMode = true;
            ...
            this._area = new Rectangle(((-(_arg_1.stage.stageWidth) * 1.5) + _local_2.x), ((-(_arg_1.stage.stageHeight) * 1.5) + _local_2.y), (_arg_1.stage.stageWidth * 3), (_arg_1.stage.stageHeight * 3));
        ...
        private function onMouseClick(_arg_1:MouseEvent):void
        {
            ...
            {
                _local_2 = new Point(_arg_1.localX, _arg_1.localY);
            ...
            else
            {
                if (this._points.length == 1)
                {
                    ...
                    _local_4 = new Point(_arg_1.localX, _arg_1.localY);
        ...
        private function makeTxtField(_arg_1:Number, _arg_2:Boolean=true):TextField
        {
            var _local_3:TextFormat = new TextFormat(this._config.style.menuFont, this._config.style.menuFontSize, _arg_1, _arg_2, true, null, null, TextFormatAlign.RIGHT);
        ...
        private function round(_arg_1:Number, _arg_2:uint=10):Number
        {
            return (Math.round((_arg_1 * _arg_2)) / _arg_2);
        }

        private function angle(_arg_1:Point, _arg_2:Point):Number
        {
            var _local_3:Number = ((Math.atan2((_arg_2.y - _arg_1.y), (_arg_2.x - _arg_1.x)) / Math.PI) * 180);
        ...
        private function drawCircleSegment(_arg_1:Graphics, _arg_2:Number, _arg_3:Point, _arg_4:Number=180, _arg_5:Number=0):Point
        {
            var _local_12:Number;
            ...
            {
                _local_6 = true;
                _arg_4 = Math.abs(_arg_4);
            };
            var _local_7:Number = ((_arg_4 * Math.PI) / 180);
            var _local_8:Number = ((_arg_5 * Math.PI) / 180);
            var _local_9:Point = this.getPointOnCircle(_arg_2, _local_8);
            _local_9.offset(_arg_3.x, _arg_3.y);
            _arg_1.moveTo(_local_9.x, _local_9.y);
            var _local_10:Number = 0;
            var _local_11:int = 1;
            while (_local_11 <= (_local_7 + 1))
            {
                _local_12 = ((_local_11 <= _local_7) ? _local_11 : _local_7);
                _local_13 = (_local_12 - _local_10);
                _local_14 = (1 + ((0.12 * _local_13) * _local_13));
                _local_15 = this.getPointOnCircle((_arg_2 * _local_14), (((_local_12 - (_local_13 / 2)) * ((_local_6) ? -1 : 1)) + _local_8));
                _local_15.offset(_arg_3.x, _arg_3.y);
                _local_9 = this.getPointOnCircle(_arg_2, ((_local_12 * ((_local_6) ? -1 : 1)) + _local_8));
                _local_9.offset(_arg_3.x, _arg_3.y);
                _arg_1.curveTo(_local_15.x, _local_15.y, _local_9.x, _local_9.y);
                _local_10 = _local_12;
                _local_11++;
            };
            return (_local_9);
        ...
        private function getPointOnCircle(_arg_1:Number, _arg_2:Number):Point
        {
            return (new Point((_arg_1 * Math.cos(_arg_2)), (_arg_1 * Math.sin(_arg_2))));
        }
