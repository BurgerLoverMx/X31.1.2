...
package robotlegs.bender.bundles.mvcs
{
    ...
    public class MVCSBundle implements IBundle 
    {
        ...
        {
            _arg_1.extend(LoggingExtension, TraceLoggingExtension, ContextViewExtension, EventDispatcherExtension, ModularityExtension, CommandCenterExtension, EventCommandMapExtension, LocalEventMapExtension, ViewManagerExtension, StageObserverExtension, ManualStageObserverExtension, MediatorMapExtension, StageSyncExtension);
            _arg_1.configure(ContextViewListenerConfig);
        }
